...
import { KEY , API_URL,ret_type,ret_limit,AmountReleasedByDSTForCentralSectorSchemeFrom201819To202021_Resource,
  ...
  MPhilDoctorateDegreesAwardedFacultyWise199091To201011,OrdinaryApplicationsPatentsFiledFrom198081To201011ByDifferentStates,AmountReleasedByDSTForCentralSectorSchemeFrom201819To202021,
  ResearchersPerMillionPeopleForSelectedCountriesIn2009} from "../src/Const/Const";
  ...
  return (
    ...
    <div style={{
        ...
        <button className={classes.button} onClick={getOrdinaryApplicationsPatentsFiledFrom198081To201011ByDifferentStates}>{OrdinaryApplicationsPatentsFiledFrom198081To201011ByDifferentStates}</button>
         {/* <button className={classes.button} onClick={getAmountReleasedByDSTForCentralSectorSchemeFrom201819To202021 }>{AmountReleasedByDSTForCentralSectorSchemeFrom201819To202021}</button> */}
