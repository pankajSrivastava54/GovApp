...
export function Transcription({ loggedIn, logout, login }) {
...
function onFileChange(event)  {
  ...
  function handleSubmit(e) {
    ...
    var claimUrl = "https://api.openai.com/v1/audio/transcriptions";
  ...
  //console.log(voice);
    ...
    const fetchMethod = {
      ...
      //   });
      // });
    // fetch('https://api.openai.com/v1/audio/speech?username='+username+'&password='+password)
    ...
    //         if(localStorage.getItem("isauthenticated").localeCompare(false) === 0){
    //             //changeView('EmployeeListView',true);
    //         }
    //     }
    // );
